    ...
    <section className="relative w-full min-h-screen flex flex-col justify-center items-center pt-28 sm:pt-36 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center flex flex-col items-center justify-center my-auto">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Most organisations cannot answer three basic questions: which AI systems are running, who owns them, and what happens if one behaves badly. That gap is uncomfortable in a board meeting and untenable in front of a regulator. We produce the inventory, the risk picture, and a remediation path ordered by what actually matters.
          </motion.p>
          ...
          >
            ...
            >
              <span>Scope a Readiness Audit</span>
