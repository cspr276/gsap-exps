    ...
    <section className="relative w-full min-h-screen flex flex-col justify-center items-center pt-28 sm:pt-36 pb-20 overflow-hidden bg-[#09090b]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center flex flex-col items-center justify-center my-auto">
        <div className="max-w-4xl mx-auto">
          ...
          >
            A Demo Agent Needs to Work Once.{' '}
            <span className="text-neutral-300 font-bold block sm:inline">
              Yours Needs to Work on Tuesday.
            </span>
          </motion.h1>
          ...
          >
            The distance between a convincing prototype and production is mostly unglamorous: least-privilege permissions, error recovery, audit traces, and knowing what the system does when a model hallucinates. We build the architecture that keeps autonomous workflows standing.
          </motion.p>
          ...
          >
            ...
            >
              <span>Scope an Agent Workflow</span>
            ...
            >
              <span>Explore System Console</span>
