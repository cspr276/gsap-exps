...
const METRICS: MetricItem[] = [
  {
    ...
    detail: 'Continuous longitudinal distribution tracking across prompt revisions and model updates.',
  },
  {
    value: '100%',
    label: 'Segmented Cohort Signals',
    detail: 'Quality tracked by user cohort and turn depth before global averages erode.',
  },
  {
    value: '0',
    label: 'Regressions to Merged Branch',
    detail: 'Fixed failure cases permanently committed to blocking CI/CD test gates.',
  },
  {
    value: '< 100ms',
    label: 'Telemetry Overhead',
    detail: 'Asynchronous stratified sampling that preserves real-time response budgets.',
  },
];
