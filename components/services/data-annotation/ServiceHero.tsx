...
export default function ServiceHero() {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-center items-center pt-28 sm:pt-36 pb-20 overflow-hidden bg-[#09090b]">
      {/* Authentic infrastructure background */}
      <div className="absolute inset-0 z-0 pointer-events-none select-none">
        <Image
          src="/services/hero-datacenter.jpg"
          alt="Data Annotation & Gold Standard Infrastructure"
          fill
          priority
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <span className="font-mono text-xs uppercase tracking-[0.2em] text-neutral-400 font-semibold inline-block border border-neutral-700/60 bg-neutral-900/60 backdrop-blur-md px-3.5 py-1.5 rounded-md">
              DATA ANNOTATION & GOLD STANDARDS
            </span>
          </motion.div>
          ...
          >
            Nobody sets out to buy bad labels. They arrive anyway — from guidelines that read clearly until two experts disagree, from annotators guessing at domain intent, and from pipelines with no mechanism for noticing. We build the process that makes quality measurable, then staff it with verified domain specialists.
          </motion.p>

          {/* Centered High-Contrast Action CTAs with clean rectangular borders */}
          <motion.div
            initial={{ opacity: 0, y: 14 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            >
              <span>Scope an Annotation Cohort</span>
            ...
            >
              <span>Explore Quality Workbench</span>
