...
const METRICS = [
  {
    ...
    detail: 'You cannot tell whether training worked without a rigorous empirical baseline that predates it.',
  },
  {
    value: '100%',
    label: 'Demonstration Curation',
    detail: 'Domain-expert authored gold standard examples with verified formatting and citation fidelity.',
  },
  {
    value: 'DPO & PPO',
    label: 'Preference Alignment',
    detail: 'Subtle domain trade-offs and non-deterministic nuance aligned through expert pairwise comparisons.',
  },
  {
    value: '< 2k',
    label: 'High-Signal Examples',
    detail: 'A few thousand agreement-checked demonstrations consistently outperforming massive noisy datasets.',
  },
];
