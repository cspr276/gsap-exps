    ...
    <section className="relative w-full overflow-hidden bg-neutral-950 text-white py-32 sm:py-40 lg:py-48 flex items-center justify-center border-t border-neutral-900">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-12 text-center flex flex-col items-center">
        ...
        <p className="text-neutral-400 text-base sm:text-lg md:text-xl font-normal leading-relaxed max-w-2xl mb-10">
          Talk to our team about scoping an evaluation, adversarial red-team run, or continuous regression gate for your models and agentic workflows.
        </p>

        {/* CTA Buttons with less curvy borders (rounded-md) */}
