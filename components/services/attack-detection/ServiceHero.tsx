    ...
    <section className="relative w-full min-h-screen flex flex-col justify-center items-center pt-28 sm:pt-36 pb-20 overflow-hidden bg-[#09090b]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center flex flex-col items-center justify-center my-auto">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Testing tells you where a system breaks. Detection tells you when someone is breaking it right now. We build the runtime layer that watches live traffic for injection, abuse, and anomalous agent behavior — sized to a latency budget you can defend to your platform team.
          </motion.p>
          ...
          >
            ...
            >
              <span>Scope Runtime Defense</span>
            ...
            >
              <span>Explore Detection Workbench</span>
