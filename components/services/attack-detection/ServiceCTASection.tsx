  ...
  return (
    <section className="relative w-full overflow-hidden bg-neutral-950 text-white py-32 sm:py-40 lg:py-48 flex items-center justify-center border-t border-neutral-900">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <Aurora
          colorStops={['#38bdf8', '#818cf8', '#c084fc']}
          blend={0.5}
          amplitude={0.5}
          speed={1}
        />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-12 text-center flex flex-col items-center">
        ...
        <h2 className="font-display font-bold text-3xl sm:text-5xl md:text-6xl tracking-tight text-white leading-[1.15] mb-6 max-w-3xl">
          Contain attacks in milliseconds{' '}
          <span className="text-neutral-300">before data leaves your boundary.</span>
        </h2>
        ...
        <p className="text-neutral-300 text-base sm:text-lg md:text-xl font-normal leading-relaxed max-w-2xl mb-10">
          Talk to our AI security team about profiling live traffic, calibrating precision thresholds, and enforcing deterministic egress allowlists across your production models.
        </p>

        {/* CTA Buttons with clean rounded-md borders */}
        ...
        {/* Trust Badges - Clean rectangular style without indicator dots */}
        <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 text-neutral-400 font-mono text-xs uppercase tracking-wider pt-4 border-t border-neutral-800/80">
          <span>Sub-5ms Inline Overhead</span>
          <span className="hidden sm:inline text-neutral-700">|</span>
          <span>Zero Egress Bypass</span>
          <span className="hidden sm:inline text-neutral-700">|</span>
          <span>Calibrated Precision</span>
        </div>
      </div>
    </section>
  );
