...
export default function Footer() {
  return (
    <footer className="relative w-full bg-neutral-950 pt-24 pb-16 px-4 sm:px-8 lg:px-12 overflow-hidden">
      {/* Huge faint background watermark text matching reference image */}
      <div className="absolute top-8 inset-x-0 flex justify-center pointer-events-none select-none z-0">
        <span
          className="font-display font-black text-[18vw] leading-none tracking-tight text-white/[0.03] uppercase whitespace-nowrap"
          style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto rounded-3xl bg-[#141414] border border-white/5 p-8 sm:p-12 lg:p-16 shadow-2xl shadow-black/80">
